    ...
    for segment in listOfSegments:
        for endOfSegment in range(2):
            for n, neighbor in enumerate(segment.links[endOfSegment]):
                if (
                    not segment
                    in neighbor.links[segment.otherEndOfLinks[endOfSegment][n]]
                ):
                    print(
                        "Problem in links, a one-end link going from: ",
                        segment.names,
                        endOfSegment,
                        " to ",
                        neighbor.names,
                ...
                if (
                    ...
                    and endOfSegment == segment.otherEndOfLinks[endOfSegment][n]
                ):
                    count = 0
                    for t in range(len(segment.links[endOfSegment])):
                        if (
                            segment.links[endOfSegment][t].ID == segment.ID
                            and segment.otherEndOfLinks[endOfSegment][t] == endOfSegment
                        ):
                            count += 1
                    ...
                    if count != 2:
                        print(
                            ...
                            segment.otherEndOfLinks[endOfSegment][n],
                            ". The total lists are : ",
                            [i.names for i in segment.links[endOfSegment]],
